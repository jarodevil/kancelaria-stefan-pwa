...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: MessageSquare, label: "Chat z Ekspertem", href: "/chat" },
  ...
  return (
    <div className="w-64 h-screen bg-card border-r border-border flex flex-col text-muted-foreground">
      {/* Header */}
      <div className="p-4 border-b border-border">
        <div className="flex items-center gap-2 text-primary mb-1">
          ...
          <span className="font-bold text-lg tracking-tight text-foreground">KancelariaAI</span>
        </div>
        <p className="text-[10px] text-muted-foreground uppercase tracking-wider pl-8">System Stefan v1.5</p>
      </div>
      ...
      <div className="p-4 border-t border-border space-y-4">
        <Link href="/privacy">
          <a className="flex items-center gap-3 px-3 py-2 text-xs text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="bg-muted/50 rounded-lg p-3">
          <p className="text-xs font-medium text-foreground mb-1">System Stefan</p>
          <p className="text-[10px] text-muted-foreground">Wersja v1.5 (Stabilna)</p>
